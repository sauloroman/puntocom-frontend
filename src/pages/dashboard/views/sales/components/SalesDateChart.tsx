...
export const SalesDateChart: React.FC<SalesDateChartProps> = ({ data }) => {
    ...
    if (!data.length) {
        ...
        <div
            ...
            `}
        >
            <p className='text-sm'>Sin datos de ventas por fecha</p>
        </div>
        )
    }
    ...
    return (
        ...
        <ResponsiveContainer width='100%' height={260}>
            ...
            <defs>
                <linearGradient id='grad-sales-date' x1='0' y1='0' x2='0' y2='1'>
