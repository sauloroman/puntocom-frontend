        ...
        <ModalLayout width='w-xl'>
            <form onSubmit={handleSubmit(onSaveInventoryAdjustment)} className="flex-2 space-y-6 mb-4">
                ...
                <div className="flex-1">
                    ...
                    />
                    {errors.adjustmentQuantity && <ErrorMessageForm message={errors.adjustmentQuantity.message} />}
                </div>
                ...
                <div className="flex-1">
                    ...
                    />
                    {errors.adjustmentReason && <ErrorMessageForm message={errors.adjustmentReason.message} />}
                </div>
                
                <div className='flex items-center gap-5 justify-end mt-6 w-full'>
                    <SaveButton className='p-2 flex-1' submit text='Guardar Ajuste' />
                    <CancelButton className='p-2 flex-1' onClick={onCloseModalSaveAdjustment} text='Cancelar' />
                </div>
