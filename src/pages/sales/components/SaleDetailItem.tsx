            ...
            `}>
                ...
                `}>
                    <div className="flex items-center space-x-4">
                        ...
                        <span>
                            Descuento: <span className={`
                                font-medium transition-colors
                                ${isDark ? 'text-gray-200' : 'text-gray-900'}
                            `}>
                                ${detail.saleDiscount.toFixed(2)}
                            </span>
                        </span>
                        <span>
                            Precio: <span className={`
                                ...
                                ${isDark ? 'text-gray-200' : 'text-gray-900'}
                            `}>
                                ${detail.saleUnitPrice.toFixed(2)}
                            </span>
                        </span>
                        <span>
                            Subtotal: <span className={`
                                ...
                                ${isDark ? 'text-gray-200' : 'text-gray-900'}
                            `}>
                                ${calculateSubtotal(detail.saleUnitPrice, detail.saleQuantity, detail.saleDiscount)}
                            </span>
                        </span>
                    </div>
                </div>
