...
import { useAlert, useCategories, useDrawer } from '../../hooks'
...
export const CategoryEditDrawer: React.FC = () => {
    ...
    const { categorySelected, updateCategory, isLoading } = useCategories()
        ...
        <RightDrawerLayout width='w-2xl' title='Editar Categoría'>
            {
                ...
                ? ( <SpinnerContainer /> )
                : (
                    <form onSubmit={handleSubmit(onEditCategory)} className='space-y-6 p-4'>
                        <div>
