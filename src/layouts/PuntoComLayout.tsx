...
import { useMenu, useModal, useTheme } from '../shared/hooks'
import { Menu } from '../shared/components/menu'
import { ModalNames } from '../interfaces/ui/modal.interface'
import { ModalReminderStock } from '../pages/login/components'
...
export const PuntoComLayout: React.FC<PuntoComLayoutProps> = ({ children }) => {
  ...
  return (
    <>
      ...
      { modalIsOpen && modalName === ModalNames.reminderStock && <ModalReminderStock />}
    </>
  )
}